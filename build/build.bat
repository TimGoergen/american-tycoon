...
:: Local build script for American Tycoon.
:: Mirrors the GitHub Actions CI process so you can produce builds on your machine.
::
:: Prerequisites:
::   - Godot 4.5.1 available as "godot" on your PATH
...
echo.
echo ================================================
echo  American Tycoon Local Build   [!VERSION!]
echo ================================================
echo.
...
popd
rename dist\american_tycoon_win.exe "american_tycoon_!SHA!_win.exe"
echo       Done: dist\american_tycoon_!SHA!_win.exe

:: ── Step 2: Windows installer ────────────────────────────────────────────────
echo [2/3] Building Inno Setup installer...
"!ISCC!" ^
    "/DAppVersion=!VERSION!" ^
    "/DSourceExe=%CD%\dist\american_tycoon_!SHA!_win.exe" ^
    "/DOutputDir=%CD%\dist" ^
...
echo       Done: dist\american_tycoon_setup_!SHA!.exe
...
popd
rename dist\american_tycoon.apk "american_tycoon_!SHA!.apk"
echo       Done: dist\american_tycoon_!SHA!.apk
