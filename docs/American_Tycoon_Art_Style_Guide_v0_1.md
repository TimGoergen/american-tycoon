...
Format: portrait bust in a circular cream medallion on navy card; name plate (slab serif) + role; the **quiet ratio** stat pair beneath (hire cost vs. lifetime revenue — Mechanics Spec §6 / GDD §6). Faces: simplified flat-vector 50s-ad people — dot eyes, confident smiles, period hair; skin tones from a warm limited ramp added to §1 when first needed. Same halftone, same double frame.
