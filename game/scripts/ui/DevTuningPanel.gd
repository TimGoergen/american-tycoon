...
const DESCRIPTIONS := {
	...
	"rush_momentum_vent_window_delay_min": "Soonest a vent window can arrive after entering Critical or after a vent (seconds).",
	"rush_momentum_vent_window_delay_max": "Latest a vent window can arrive (seconds) — the roll that keeps its timing unpredictable.",
	"rush_momentum_vent_window_duration": "Seconds to finish the vent gesture once the window telegraphs.",
	"rush_momentum_vent_window_tighten": "Seconds shaved off the window per vent tier already earned (floor 0.5s).",
	...
	"rush_momentum_vent_heat_drop": "Heat released by a successful vent (you fall back within Critical, not out of it).",
	"rush_momentum_vent_bonus_step": "Peak bonus added per successful vent (0.20 = +20% per rung).",
	"rush_momentum_vent_max_tiers": "Most vent rungs one excursion can climb (the bonus-ladder cap).",
	"rush_momentum_vent_double_from_tier": "First earned tier whose NEXT window demands the double-lift VENT x2 gesture.",
	"rush_momentum_vent_fail_rearm_per_tier": "Extra re-arm seconds per earned vent tier when you overheat; 0 = off.",
	"rush_momentum_haptic_critical_ms": "Vibration length (ms) on entering the Critical band; 0 = off.",
...
const DISPLAY_NAMES := {
	...
	"rush_momentum_vent_window_delay_min": "Vent Delay Min",
	"rush_momentum_vent_window_delay_max": "Vent Delay Max",
	"rush_momentum_vent_window_duration": "Vent Window Sec",
	"rush_momentum_vent_window_tighten": "Vent Tighten /Tier",
	...
	"rush_momentum_vent_max_tiers": "Vent Max Tiers",
	"rush_momentum_vent_double_from_tier": "Vent x2 From Tier",
	"rush_momentum_vent_fail_rearm_per_tier": "Vent Fail Re-arm /Tier",
	"rush_momentum_haptic_critical_ms": "Critical Haptic ms",
