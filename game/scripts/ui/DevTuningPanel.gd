...
const DESCRIPTIONS := {
	...
	"challenge_goal_growth": "How much each challenge tier's score target grows over the last (1.6 = +60% per rung).",
	"challenge_reward_base_pct": "The tier-1 challenge income bonus, as a fraction (0.005 = +0.5%); later tiers pay less.",
	"challenge_reward_decay": "How fast each challenge tier's bonus shrinks (0.6 = 60% of the last); under 1 keeps the total bounded.",
