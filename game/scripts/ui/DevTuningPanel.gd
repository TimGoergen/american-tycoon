...
const DESCRIPTIONS := {
	...
	"rush_momentum_max_bonus": "Cap on the Rush Momentum income bonus (0.3 = up to +30%). The main pinch dial.",
	"rush_momentum_build_per_second": "How fast momentum climbs while rushing (bonus-fraction/sec).",
	"rush_momentum_bleed_per_second": "How fast momentum bleeds away when NOT rushing (bonus-fraction/sec).",
...
const DISPLAY_NAMES := {
	...
	"rush_momentum_max_bonus": "Momentum Max Bonus",
	"rush_momentum_build_per_second": "Momentum Build /s",
	"rush_momentum_bleed_per_second": "Momentum Bleed /s",
