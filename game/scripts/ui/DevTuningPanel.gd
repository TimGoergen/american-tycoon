...
const DESCRIPTIONS := {
	...
	"rush_momentum_vent_delay_decay": "Window arrival delay multiplier per tier reached (0.88 = 12% faster each tier).",
	"rush_momentum_vent_delay_floor": "Shortest the escalating arrival delay can get (seconds).",
...
const DISPLAY_NAMES := {
	...
	"rush_momentum_vent_delay_decay": "Vent Delay Decay",
	"rush_momentum_vent_delay_floor": "Vent Delay Floor",
